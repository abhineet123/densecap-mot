...
NCCL_IB_DISABLE=1 NCCL_SOCKET_IFNAME=eth0 python -m torch.distributed.launch --nproc_per_node=2 --master_port=47769 train.py --cfgs_file cfgs/MNIST_MOT_RGB_512x512_1_100_960_var/all_seq_fix_20-f0_max_16-mask.cfg --batch_size 40 --num_workers 4 --world_size 2 --distributed 1 
