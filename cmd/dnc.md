...
python -m torch.distributed.launch --nproc-per-node=2 python3 train.py --cfgs_file cfgs/MNIST_MOT_RGB_512x512_1_100_960_var/all_seq_fix_20-f0_max_16-mask.cfg --batch_size 40 --num_workers 4
