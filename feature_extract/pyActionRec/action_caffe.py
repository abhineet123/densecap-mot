...
# caffe_path = ANET_CFG.CAFFE_ROOT+'/python'

caffe_path = os.path.join(os.path.dirname(__file__), '..', 'lib/caffe-action/python')

print(f'caffe_path: {caffe_path}')
sys.path.append(caffe_path)

import caffe
from caffe.io import oversample
import numpy as np
from pyActionRec.utils.io import flow_stack_oversample
import cv2
